class Metronomo{
    ...
    createElement() {
        ...
        this.element.classList.add("Metronomo");
        ...
        <div class=up>
        <button class="bipc1"></button>
      
        <button class="bipc3"></button>
  
        <button class="bipc5"></button>
     
        <button class="bipc7"></button>

        <button class="bipc9"></button>
     
        <button class="bipc11"></button>
     
        <button class="bipc13"></button>

        <button class="bipc15"></button>
        ...
        <button class="bum">a</button>
        <button class="pa">s</button>
